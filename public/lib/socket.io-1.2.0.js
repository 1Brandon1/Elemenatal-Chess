				...
				function (_dereq_, module, exports) {
					;(function (global) {
						...
						function url(uri, loc) {
							...
							obj.path = obj.path || '/'
							obj.id =
								obj.protocol + '://' + obj.host + ':' + obj.port
							obj.href =
								obj.protocol +
								'://' +
								obj.host +
						...
						exports.encodePayloadAsArrayBuffer = function (
							...
							map(
								...
								function (err, encodedPackets) {
									...
									var resultArray = new Uint8Array(
										totalLength
									)
									var bufferIndex = 0
				...
				function (_dereq_, module, exports) {
					...
					function encodeAsBinary(obj, callback) {
						function writeEncoding(bloblessData) {
							var deconstruction =
								binary.deconstructPacket(bloblessData)
